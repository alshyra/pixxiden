...
export async function refreshLibrary() {
  ...
  console.log(
    `[Mock] refreshLibrary: Complete. Storage=${result.mockGamesInStorage}, MockMode=${result.mockModeEnabled}, StoreGames=${result.storeGamesCount}, Loading=${result.storeLoading}, Error=${result.storeError}, Pinia=${result.hasPinia}`,
  );
}
