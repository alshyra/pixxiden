...
describe("Store Authentication", () => {
  ...
  describe("Settings Store Section", () => {
    ...
    it("should have connection buttons for stores", async () => {
      ...
      console.log(
        "Button texts:",
        buttonTextsArray.filter((t) => t.length > 0),
      );
  ...
  describe("Store Configuration", () => {
    it("should allow navigation between settings sections", async () => {
      ...
      const hasSystemSection =
        bodyText.toLowerCase().includes("system") || bodyText.toLowerCase().includes("système");
      const hasAccountsSection =
        bodyText.toLowerCase().includes("account") || bodyText.toLowerCase().includes("compte");
      const hasAdvancedSection =
        bodyText.toLowerCase().includes("advanced") || bodyText.toLowerCase().includes("avancé");
