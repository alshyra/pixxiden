<template>
  <div class="setup-wizard fixed inset-0 bg-black z-[9999] flex items-center justify-center">
    <!-- Background gradient -->
    <div
      class="absolute inset-0 bg-gradient-to-br from-[#1a1a2e] via-black to-[#16213e] opacity-90"
    />
    ...
    <div class="relative z-10 w-full max-w-2xl mx-4">
      ...
      <!-- Step content -->
      <div
        class="bg-[#0f0f12]/95 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden"
      >
        <!-- Step 1: Welcome -->
        <Transition name="fade" mode="out-in">
          <div v-if="currentStep === 1" key="step1" class="p-8">
            ...
            <p class="text-white/60 text-center mb-6">
              Pour enrichir votre bibliothèque avec des images et métadonnées de jeux, vous pouvez
              configurer des clés API optionnelles.
            </p>
            ...
            <div class="bg-[#5e5ce6]/10 border border-[#5e5ce6]/30 rounded-xl p-4 mb-6">
              <div class="flex items-start gap-3">
                ...
                <div class="text-sm text-white/70">
                  ...
                  <p>
                    Sans clés API, Pixxiden fonctionnera normalement mais sans images enrichies ni
        ...
        <Transition name="fade" mode="out-in">
          <div v-if="currentStep === 2" key="step2" class="p-8">
            ...
            <div class="space-y-4 mb-6">
                ...
                <ol class="text-sm text-white/60 space-y-2 list-decimal list-inside">
                  <li>
                    ...
                    <a
                      ...
                      target="_blank"
                      class="text-[#5e5ce6] hover:underline"
                      >steamgriddb.com</a
                    >
                  </li>
              ...
              <div
                v-if="testResults.steamgriddbMessage"
                class="text-sm"
                :class="testResults.steamgriddbValid ? 'text-green-400' : 'text-red-400'"
              >
        ...
        <Transition name="fade" mode="out-in">
          <div v-if="currentStep === 3" key="step3" class="p-8">
            <div class="flex items-center gap-3 mb-6">
              <div
                class="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center text-2xl"
              >
                📊
              </div>
              <div>
            ...
            <div class="space-y-4 mb-6">
              ...
              <div>
                <label class="block text-sm font-medium text-white/70 mb-2"> Client ID </label>
                <input
              ...
              <div>
                <label class="block text-sm font-medium text-white/70 mb-2"> Client Secret </label>
                <input
              ...
              <div
                v-if="testResults.igdbMessage"
                class="text-sm"
                :class="testResults.igdbValid ? 'text-green-400' : 'text-red-400'"
              >
        ...
        <Transition name="fade" mode="out-in">
          <div v-if="currentStep === 4" key="step4" class="p-8">
            <div class="flex items-center gap-3 mb-6">
              <div
                class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center text-2xl"
              >
                🏆
              </div>
              <div>
            ...
            <div class="space-y-4 mb-6">
              ...
              <div>
                <label class="block text-sm font-medium text-white/70 mb-2"> Clé API Steam </label>
                <input
              ...
              <div
                v-if="testResults.steamMessage"
                class="text-sm"
                :class="testResults.steamValid ? 'text-green-400' : 'text-red-400'"
              >
          ...
          <div v-if="currentStep === 5" key="step5" class="p-8">
            ...
            <div class="space-y-3 mb-8">
              ...
              <div class="flex items-center justify-between p-4 bg-[#1a1a1f] rounded-xl">
                ...
                <span
                  :class="
                    formData.igdbClientId && formData.igdbClientSecret
                      ? 'text-green-400'
                      : 'text-white/40'
                  "
                >
              ...
              <div class="flex items-center justify-between p-4 bg-[#1a1a1f] rounded-xl">
                ...
                <span
                  :class="
                    formData.steamApiKey && formData.steamId ? 'text-green-400' : 'text-white/40'
                  "
                >
