    ...
    <div class="animate-fade-in">
        ...
        <div class="flex flex-col gap-6">
            <Card variant="glass" class="!p-6">
                <!-- Proton Version -->
                <SettingsRow title="Version Proton Global"
                    description="Compatibilité par défaut pour les titres Windows.">
                    <Select :model-value="protonVersion" :options="protonVersions"
                        placeholder="Sélectionner une version"
                        @update:model-value="(val) => $emit('update:protonVersion', String(val))" />
                </SettingsRow>

                <!-- MangoHud Overlay -->
                <SettingsRow title="MangoHud Overlay" description="Affiche FPS, températures et utilisation matérielle."
                    :divider="false">
                    <Toggle :model-value="mangoHudEnabled"
