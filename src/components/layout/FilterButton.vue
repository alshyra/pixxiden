<template>
  <button class="flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-all"
    ...
    <!-- Active indicator -->
    <div class="h-0.5 w-8 rounded-full transition-all" :class="active ? 'bg-white' : 'bg-transparent'" />
  </button>
</template>
