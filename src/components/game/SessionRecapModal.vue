    ...
    <Transition name="modal">
      ...
      >
        ...
        >
          ...
          <div
            class="relative h-32 bg-gradient-to-br from-purple-900/50 via-blue-900/30 to-cyan-900/20"
          >
            <img
            ...
            <div class="absolute bottom-4 left-6 right-6">
              <h2 class="text-2xl font-black italic text-white tracking-tight">Session terminée</h2>
          ...
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <p class="text-3xl font-black text-[#5e5ce6] mb-1">
                  {{
                    game?.playTimeMinutes
                      ? formatTotalTime(game.playTimeMinutes + Math.floor(sessionDuration / 60))
                      : "N/A"
                  }}
                </p>
                <p class="text-[10px] font-bold text-white/40 uppercase tracking-wider">
              ...
              <div class="bg-[#1a1a1e] rounded-xl p-4 text-center border border-white/5">
                ...
                <p class="text-[10px] font-bold text-white/40 uppercase tracking-wider">Succès</p>
              </div>
            </div>
            ...
            <div class="bg-[#1a1a1e]/50 rounded-xl p-4 border border-white/5">
              ...
              <div class="flex items-center justify-between py-2 border-b border-white/5">
                ...
                <span class="text-sm font-semibold text-white">{{
                  formatDateTime(sessionEndTime)
                }}</span>
              </div>
              <div class="flex items-center justify-between py-2">
                <span class="text-sm text-white/50">Store</span>
                <span class="text-sm font-semibold text-white">{{
                  getStoreName(game?.store)
                }}</span>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <Button
                ...
                class="!rounded-xl"
                :class="{
                  'ring-2 ring-green-400 ring-offset-2 ring-offset-[#0f0f12]':
